...
class Card extends Component{
    ...
    likes() {
        ...
        .then(()=> 
        console.log('like', auth.currentUser.email)
           )
        ...
        return(
            <View style={style.cardContainer}>
                    <View style={style.flex}>
                        ...
                        <TouchableOpacity onPress={() => this.props.homeProps.navigation.navigate('Registro', { email: this.props.data.data.owner })}>
                            <Text style={style.creador}>nmashe</Text>
                        </TouchableOpacity>
